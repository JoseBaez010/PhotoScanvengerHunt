    ...
    static var mockedTasks: [Task] {
        return [
            Task(title: "Your favorite local restaurant",
                 description: "Where do you want to go to get the best food?"),
            Task(title: "Your favorite local cafe",
                 description: "Where do you want to go to get the best coffee?"),
            Task(title: "Your go-to brunch place",
                 description: "Where do you want to go to get the best brunch?"),
